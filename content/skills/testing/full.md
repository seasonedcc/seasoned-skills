...
The coverage register — {{coverage-register}} — carries the routes no spec reaches yet
...
excused-surfaces list — {{excused-surfaces}} — takes a route only with a written
