...
```bash
agent-browser open https://example.com --session recipe-dna
# ... every interaction of the run ...
agent-browser close --session recipe-dna
```
