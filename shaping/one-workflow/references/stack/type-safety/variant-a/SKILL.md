...
- `ListInput` — `{ page: number; perPage: number }` from `~/framework/schemas`
- Common schemas (`checkboxSchema`, `destroySchema`, `emptySchema`, `slugSchema`, `makeListInput`) from `~/framework/schemas`
- Context schemas (`contextSchema`, `userContextSchema`, `customerContextSchema`, `adminContextSchema`) from `~/business/auth.server`
- Database table types from `apps/web/app/db/types.d.ts` (auto-generated, do not edit)
