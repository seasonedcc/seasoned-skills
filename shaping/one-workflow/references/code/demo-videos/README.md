...
Turns narration text into a WAV spoken by the repo's narrator. It is the voice
...
`voices/emily.wav` is the narrator. It is committed rather than downloaded so
every video in this repo speaks with one voice, this year and next.
`voices/VOICE.md` records where it comes from and under what licence.
