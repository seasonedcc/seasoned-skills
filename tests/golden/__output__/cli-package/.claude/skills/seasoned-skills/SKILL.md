...
2. Fix the configuration, or fix every content file the report names: rename it to the skill it belongs to, give it the `.md` extension, write the section it is missing (a file with no skill can move into a subdirectory, or go).
