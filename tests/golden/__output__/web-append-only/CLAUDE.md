...
A `/goal` effort keeps its state on a Vertical board beside the shaping document: you seed it from the document, you alone write to it, and a task is done there only once you have verified it. The `orchestration` skill carries the practice.
