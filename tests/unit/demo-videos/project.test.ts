...
describe('handOverPath', () => {
  it('names the video by the day it was assembled and the whole project', () => {
    const finished = {
      ...
      video:
        '.claude/skills/demo-videos/scripts/out/recipe-dna-moves-in/highlights/recipe-dna-moves-in-highlights.mp4',
    }
...
describe('handOver', () => {
  ...
  it('keeps the video of every earlier day it was rendered on', async () => {
    ...
    expect(
      await readFile(
        path.join(finished.source, '2026-08-18-recipe-dna-moves-in-highlights.mp4'),
        'utf8',
      ),
