...
import { type ScheduledMove, scheduleMoves } from './cues.js'
import { assertCursorDrawn, installCursor } from './cursor.js'
import { travelPath, typingCadence } from './pacing.js'
import type { Move, Production, Scene, Screenplay, Target } from './screenplay.js'
