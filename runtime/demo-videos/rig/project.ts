...
import { RIG_ROOT } from './narration.js'
import type { Production, Screenplay } from './screenplay.js'

/** The rig is generated into `.claude/skills/demo-videos/scripts/`, so the
 *  consuming project's root is three directories up from the rig root, and the
 *  committed screenplays live under its `demo-videos/`. */
